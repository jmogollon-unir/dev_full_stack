...
public class OrderDto {
    ...
    public static OrderDto mapToDto(Order order) {
        return OrderDto.builder()
                ...
                .items(order.getItems() != null
                        ? order.getItems().stream().map(OrderItemDto::mapToDetailDto).collect(Collectors.toList())
                        : List.of())
                .build();
    }
    ...
    public static OrderDto mapToSummaryDto(Order order) {
        return OrderDto.builder()
                ...
                .orderDate(order.getOrderDate())
                .items(order.getItems() != null
                        ? order.getItems().stream().map(OrderItemDto::mapToSummaryDto).collect(Collectors.toList())
                        : List.of())
                .build();
    }
}
